        ...
        <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
          <div data-about-image className="relative">
            <GlassCard className="overflow-hidden p-4">
              ...
              <div className="relative rounded-[28px] bg-white/85 p-3 dark:bg-[#07111f]/90">
                <ProfilePhoto
            ...
            <div
              data-gsap-hover
              data-cursor="hover"
              className="absolute -bottom-5 left-5 hidden rounded-[24px] border border-white/10 bg-white/85 px-5 py-4 shadow-card backdrop-blur-xl dark:bg-[#07111f]/85 sm:block"
            >
